...
public class AutoRED extends NextFTCOpMode {
    ...
    private final Pose startPose = new Pose(123, 123, Math.toRadians(35)); // Start Pose of our robot.
    private final Pose scorePose = new Pose(83, 83, Math.toRadians(45)); // Scoring Pose of our robot. It is facing the goal at a 135 degree angle.
    private final Pose pickup1Pose = new Pose(121, 88, Math.toRadians(0)); // Highest (First Set) of Artifacts from the Spike Mark.

    private final Pose pickupPrep1 = new Pose(98, 88, Math.toRadians(0)); // Highest (First Set) of Artifacts from the Spike Mark.
    private final Pose pickupPrep2 = new Pose(96, 64, Math.toRadians(0)); // Highest (First Set) of Artifacts from the Spike Mark.
    private final Pose pickup2Pose = new Pose(121, 64, Math.toRadians(0)); // Middle (Second Set) of Artifacts from the Spike Mark.
    private final Pose controlPoint = new Pose(85, 57); // Middle (Second Set) of Artifacts from the Spike Mark.
    private Path scorePreload;
    private PathChain grabPickup1, scorePickup1, grabPickup2, scorePickup2, pickPrep1, pickPrep2, grabPickup3, scorePickup3;
