...
@Configurable
public class newIntake implements Subsystem {

    public static final newIntake INSTANCE = new newIntake();
    ...
    public static final MotorEx f1 = new MotorEx("intake");
