...
/**
 * Autonomous for Blue Alliance - Nationals
 *
 ...
 */
@Autonomous(name = "Auto Blue - Nationals", group = "Nationals")
public class AutoBlueNationals extends NextFTCOpMode {

    public AutoBlueNationals() {
        addComponents(
    ...
    /* ---------------- Poses (from original AutoBLUE) ---------------- */
    private final Pose startPose = new Pose(21, 123, Math.toRadians(145));
    private final Pose scorePose = new Pose(61, 83, Math.toRadians(135));
    private final Pose pickupPrep1 = new Pose(46, 87, Math.toRadians(180));
    private final Pose pickup1Pose = new Pose(23, 87, Math.toRadians(180));
    private final Pose pickupPrep2 = new Pose(48, 63, Math.toRadians(180));
    private final Pose pickup2Pose = new Pose(23, 63, Math.toRadians(180));
    private final Pose controlPoint = new Pose(60, 80);
    ...
    private static final double SHOOT_TIME = 1.0;       // Time to keep blocker open + feeding
    private static final double SPINUP_TIME = 1.5;      // Time for flywheel spinup after arriving at score
    ...
    private void autonomousPathUpdate() {
        switch (pathState) {
            ...
            case 16: // Wait for shot, then stop everything
                if (pathTimer.getElapsedTimeSeconds() > SHOOT_TIME) {
                    new InstantCommand(() -> {
                        ShooterBlockerSubsystem.INSTANCE.block();
                        IntakeSubsystem.INSTANCE.stopIntake();
    ...
    public void onInit() {
        ...
        // Set blue alliance goal coordinates
        TurretAimSubsystem.TARGET_X = 13;
        TurretAimSubsystem.TARGET_Y = 130;
    ...
    public void onWaitForStart() {
        telemetry.addLine("=== AUTO BLUE - NATIONALS ===");
